...
class MY_Model extends CI_Model
{
    ...
    public function _set_table($table = null) {
        $this->_table = ($table !== null) ? $table : $this->_fetch_table();
    }

    public function _set_primary_key($key = null) {
        $this->primary_key = $key;
    }

    public function _use_soft_delete($sd = true) {
        $this->soft_delete = $sd;
    }
    ...
    /**
     * Update many records, based on an array of key values
     */
